...
import { getActiveProject, defaultProjectLogPath, platformLogFallbacks, } from "../ue-bridge/project-detector.js";
const NO_PROJECT_HINT = "No active Unreal project yet. Call any tool with a `projectPath` " +
...
export function registerResources(server) {
    server.registerResource("ue-project-info", "unreal://project/info", {
        title: "Active UE project",
        description: "Metadata for the most recently used Unreal project: name, engine version, paths, modules, enabled plugins.",
    ...
    server.registerResource("ue-project-log", "unreal://project/log", {
        title: "Active UE project log (current)",
        description: "Tail of the current editor/runtime log for the active project (<Project>/Saved/Logs/<Project>.log). Use the read-logs tool for filtering, backups, and severity controls.",
        mimeType: "text/plain",
    }, async (uri) => {
    ...
    server.registerResource("ue-project-context", "unreal://project/context", {
        title: "UNREAL_CONTEXT.md",
        description: "The generated project overview (UNREAL_CONTEXT.md) for the active project, if it has been created with the generate-context tool.",
