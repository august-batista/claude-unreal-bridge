...
export function registerSetBlueprintPropertyTool(server) {
    server.tool("set-blueprint-property", "Set a property on a blueprint's component or on the blueprint itself (CDO). Use this to modify default values like MaxWalkSpeed on CharacterMovementComponent, jump velocity, gravity scale, etc. Changes are saved to the .uasset file.", {
        projectPath: z
            .string()
