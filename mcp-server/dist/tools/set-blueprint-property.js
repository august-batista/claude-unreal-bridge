...
function isSetPropertyResult(data) {
...
export function registerSetBlueprintPropertyTool(server) {
    server.registerTool("set-blueprint-property", {
        title: "Set Blueprint Property",
        description: "Set a property on a blueprint's component or on the blueprint itself (CDO). Use this to modify default values like MaxWalkSpeed on CharacterMovementComponent, jump velocity, gravity scale, etc. Changes are saved to the .uasset file.",
        inputSchema: {
            projectPath: z
                .string()
            ...
            componentClass: z
                .string()
                .optional()
                .describe("UE component class name to target, e.g. CharacterMovementComponent, ProjectileMovementComponent. Omit to set a property directly on the blueprint CDO."),
            propertyName: z
                .string()
                .describe("Property name in PascalCase or snake_case, e.g. MaxWalkSpeed, JumpZVelocity, GravityScale"),
            value: z
                .string()
                .describe("New value as a string. Numerics, booleans (true/false), and strings are supported."),
        },
        annotations: {
            readOnlyHint: false,
...
//# sourceMappingURL=set-blueprint-property.js.map