...
const widgetOpSchema = z.discriminatedUnion("op", [
    z.object({
        ...
        widgetClass: z
            .string()
            .describe("Widget class: a UE Python name — panels (\"CanvasPanel\", \"VerticalBox\", \"HorizontalBox\", \"Overlay\", " +
...
export function registerDesignWidgetTool(server) {
    server.registerTool("design-widget", {
        title: "Design Widget (UMG)",
        description: "Design a Widget Blueprint's UMG layout: add widgets to the tree (panels, buttons, text, images) and " +
        ...
        try {
            ...
            if (data.error) {
                return {
                    isError: true,
                    content: [{ type: "text", text: `Design widget failed: ${data.error}` }],
                };
            }
            return {
...
//# sourceMappingURL=design-widget.js.map