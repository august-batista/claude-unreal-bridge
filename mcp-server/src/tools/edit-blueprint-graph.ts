...
const opSchema = z.discriminatedUnion("op", [
  ...
  z.object({
    ...
    varType: z
      ...
      .default("int")
      .describe(
        "Base variable type. Primitives: int/bool/float/string/name/byte/text. Use \"struct\", \"object\" (object reference), or \"class\" (class reference) together with typePath.",
      ),
    typePath: z
      .string()
      .optional()
      .describe(
        "For varType struct/object/class: the type — a UE Python name (\"Vector\", \"Rotator\", \"Transform\", \"Actor\") or a full path (\"/Script/Engine.Actor\", \"/Game/Structs/S_Item.S_Item\", \"/Game/BP/BP_Foo.BP_Foo_C\").",
      ),
    container: z
