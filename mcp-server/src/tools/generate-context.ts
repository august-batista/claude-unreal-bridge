...
export function registerGenerateContextTool(server: McpServer): void {
  server.registerTool(
    "generate-context",
    {
      ...
      description:
        "Generate a comprehensive UNREAL_CONTEXT.md file for a UE project, including project overview, blueprint inventory, and class hierarchy. Writes the file to disk.",
      inputSchema: {
        projectPath: z
          .string()
