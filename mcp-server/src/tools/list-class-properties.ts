...
function isListPropertiesResult(data: unknown): data is ListPropertiesResult {
  return (
    typeof data === "object" &&
    data !== null &&
    "class_name" in data &&
    "properties" in data &&
    Array.isArray((data as ListPropertiesResult).properties)
  );
}

function formatResult(data: ListPropertiesResult): string {
  if (data.error) {
